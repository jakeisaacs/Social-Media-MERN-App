...
import { Box, Typography, Divider, useTheme } from "@mui/system";
                    ...
                    <FlexBetween gap="1rem" mb="0.5rem">
                        <FlexBetween gap="1rem">
                            ...
                            <Box>
                                ...
                                <Typography color={main} fontWeight="500">Social Network</Typography>
                            </Box>
                        </FlexBetween>
                    ...
                    <FlexBetween gap="1rem" mb="0.5rem">
                        <FlexBetween gap="1rem">
                            ...
                            <Box>
                                ...
                                <Typography color={main} fontWeight="500">Network Platform</Typography>
                            </Box>
                        </FlexBetween>
                        <EditOutlined sx={{ color: main }} />
                    </FlexBetween>
